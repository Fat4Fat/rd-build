...
3. 产品将讨论后的最终结果录入到product项目，需要对应的各个阶段创建相应的[里程碑](/jiao-fu/xu-qiu.md)，在里程碑下创建本阶段的[任务(issues)](/jiao-fu/xu-qiu.md)。
...
首先根据[本地环境构建](/jiao-fu/kai-fa.md)方法构建本地开发环境，生成项目所需的初始代码、初始数据和环境。
